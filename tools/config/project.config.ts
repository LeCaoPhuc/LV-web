...
export class ProjectConfig extends SeedConfig {
  ...
  constructor() {
    ...
    this.APP_ASSETS = [
      { src: `${this.VENDOR_SRC}/toastr/toastr.js`, inject: true, vendor: false },
      { src: `${this.VENDOR_SRC}/toastr/toastr.css`, inject: true, vendor: false },
      { src: `${this.VENDOR_SRC}/jquery.custom/date-picker.js`, inject: true, vendor: false },
    ...
    let additionalPackages: ExtendPackages[] = [
      {
        ...
        path: 'node_modules/angular2-color-picker',
        packageMeta: {
          main: 'index.js',
          defaultExtension: 'js'
        }
