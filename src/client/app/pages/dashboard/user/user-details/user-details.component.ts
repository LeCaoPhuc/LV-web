...
export class UserDetailsComponent implements OnInit {
	...
	public userError : any = {
		...
		firstname: {
			message: '',
			pattern: /[a-zA-z]|[^ÀÁÂẢÃÈÉẺÊỈÌÍÒỎÓÔÕÙÚĂĐĨŨƠàáâảãèéêếìíỉòỏóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹý ]{1,50}$/,
			name: 'Họ'
		},
		lastname: {
			message: '',
